...
const ConfirmProductModal: React.FC<ConfirmProductModalProps> = ({
    skuDetailSelected,
    isOpen,
    onOpenChange
}) => {
    ...
    const [optionSelected, setOptionSelected] =
        useState<ProductResponse>(skuDetailSelected);
