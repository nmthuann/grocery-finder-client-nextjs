    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-center mb-6">
                Giới Thiệu Về Cửa Hàng Tạp Hóa
            </h1>
            ...
            <section className="m-6">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                    ...
                    , chúng tôi tự hào mang đến{" "}
                    <span className="font-bold dark:text-[#64ff4c] text-green-600">
                        hơn 30 năm kinh nghiệm
                    </span>{" "}
                    phục vụ khách hàng. Cửa hàng chuyên cung cấp các loại{" "}
                    <span className="font-bold dark:text-[#64ff4c] text-green-600">
                        bánh kẹo
                    </span>
                    ,{" "}
                    ...
                    và nhiều mặt hàng thiết yếu khác, đảm bảo chất lượng và giá
                    cả hợp lý.
                </p>
                <p className="text-slate-600 dark:text-slate-400 mt-4">
                    Với phương châm &quot;Khách hàng là trung tâm&quot;, chúng
                    tôi luôn nỗ lực cải thiện dịch vụ và mang đến trải nghiệm
                    mua sắm tuyệt vời nhất cho khách hàng.
                </p>
            </section>
            ...
            <section className="m-6">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                    Sứ mệnh của chúng tôi là cung cấp cho khách hàng những sản
                    phẩm chất lượng cao với giá cả hợp lý, đồng thời duy trì sự
                    hài lòng và tin tưởng của khách hàng.
                </p>
            </section>
            ...
            <section className="m-6">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                    Để biết thêm thông tin hoặc có bất kỳ câu hỏi nào, vui lòng
