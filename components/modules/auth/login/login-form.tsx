...
export const LoginForm: React.FC<LoginFormProps> = ({ onPress, setSelected, isLoading }) => {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-3'>
              ...
              <FormItem>
                <FormControl>
                  <Input
                    ...
                    isRequired
                    isInvalid={isInvalid}
                    errorMessage={isInvalid ? form.formState.errors.email?.message : ''}
        ...
        <p className='text-center text-xs'>
          ...
          <Link size='sm' onPress={() => setSelected('register')} underline='hover' className='cursor-pointer'>
            Đăng ký
          </Link>
        </p>
      </form>
